...
|`__LEXICON_GOOGLE_SHEETS_AUTO_DECLARE_FILES`|`true`|Whether Lexicon Google Sheets should auto declare files when LexiconGSDeclare() is called. Note: This only applies to the first file fetch, and does not redeclare.|